...
def main():
    ...
    # Synthetic dataset
    # -------------------------------
    # NEW torch.manual_seed(0)
    prefix = "translate English to Spanish: "

    sources = [prefix + "This is a synthetic sentence." for _ in range(num_samples)]
    targets = ["Esta es una frase sintética." for _ in range(num_samples)]
