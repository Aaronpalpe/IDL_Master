"""
YOLOv8 nano inference benchmark (CPU-only).
...
def main():
    ...
    # -------------------------------
    num_runs = 5
    print(f"YOLOv8n inference on CPU | batch_size={batch_size} runs={num_runs}")
    ...
    print(f"\nInference completed (CPU). Total time: {t1-t0:.4f}s")
